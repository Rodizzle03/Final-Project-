...
alien2Y = [random.randint(30, 150) for _ in range(num_of_aliens)]
alienspeed2X = [0.25 for _ in range(num_of_aliens)]
alienspeed2Y = [30 for _ in range(num_of_aliens)]
...
max_score_per_level = 15  # Number of points needed to advance to the next level
winning_score = 150  # Number of points needed to win the game
...
def main_menu():
    ...
    start_text = font.render('Press 1 for 1 Player | Press 2 for 2 Players | Press SPACE to start', True, 'white')
    ...
    if game_active:
        ...
        if num_players == 2:
            ...
            if keys[pygame.K_RIGHT]:
                spaceship2X += 0.5
            if keys[pygame.K_UP]:  # Key for shooting
                if not check2:
                    check2 = True
        ...
        for i in range(num_of_aliens):
            ...
            if distance < 27:
                ...
                # Check if the player has reached the required score for the next level
                    ...
                    alienspeedY = [5 * level for _ in range(num_of_aliens)]
